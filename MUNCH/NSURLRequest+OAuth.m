...
static NSString * const kConsumerKey       = @"ZCI_gJLAUOL9PxrEizESJw";
static NSString * const kConsumerSecret    = @"B9dzRDACDAh_50hHd9U5gVL0NQo";
static NSString * const kToken             = @"kZlI-0u9eKJYKdWeP8tg62d1K3aMb6p2";
static NSString * const kTokenSecret       = @"1MgB3N6qrEZr3p5rA14HvWyLICo";
